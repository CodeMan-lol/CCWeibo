...
class NewPostTabView: UIView, ScrollTabViewDelegate {
    ...
    private var textBtnView: ScrollTabView?
    private var photoBtnView: ScrollTabView?
    private var hotBtnView: ScrollTabView?
    private var locBtnView: ScrollTabView?
    private var rateBtnView: ScrollTabView?
    private var moreBtnView: ScrollTabView?
    private var friendsBtnView: ScrollTabView?
    private var cameraBtnView: ScrollTabView?
    private var musicBtnView: ScrollTabView?
    private var moneyBtnView: ScrollTabView?
    private var bookBtnView: ScrollTabView?
    //核心设置代码
    func setupXib() {
    ...
    private func setupUI() {
        ...
        textBtnView = ScrollTabView(frame:rectOrigin , imageName: "tabbar_compose_idea", labelText: "文字")
        textBtnView!.delegate = self
        photoBtnView = ScrollTabView(frame: CGRectOffset(rectOrigin, btnWidth, 0), imageName: "tabbar_compose_photo", labelText: "相片／视频")
        photoBtnView!.delegate = self
        hotBtnView = ScrollTabView(frame:CGRectOffset(rectOrigin, btnWidth*2, 0) , imageName: "tabbar_compose_idea", labelText: "头条文章")
        hotBtnView!.delegate = self
        locBtnView = ScrollTabView(frame:CGRectOffset(rectOrigin, 0, btnHeight) , imageName: "tabbar_compose_lbs", labelText: "签到")
        locBtnView!.delegate = self
        rateBtnView = ScrollTabView(frame:CGRectOffset(rectOrigin, btnWidth, btnHeight) , imageName: "tabbar_compose_review", labelText: "点评")
        rateBtnView!.delegate = self
        moreBtnView = ScrollTabView(frame:CGRectOffset(rectOrigin, btnWidth*2, btnHeight) , imageName: "tabbar_compose_more", labelText: "更多")
        moreBtnView!.delegate = self
        friendsBtnView = ScrollTabView(frame:CGRectOffset(rectOrigin, btnWidth*3, 0) , imageName: "tabbar_compose_friend", labelText: "好友圈")
        friendsBtnView!.delegate = self
        cameraBtnView = ScrollTabView(frame:CGRectOffset(rectOrigin, btnWidth*4, 0) , imageName: "tabbar_compose_wbcamera", labelText: "微博相机")
        cameraBtnView!.delegate = self
        musicBtnView = ScrollTabView(frame:CGRectOffset(rectOrigin, btnWidth*5, 0) , imageName: "tabbar_compose_idea", labelText: "音乐")
        musicBtnView!.delegate = self
        moneyBtnView = ScrollTabView(frame:CGRectOffset(rectOrigin, btnWidth*3, btnHeight) , imageName: "tabbar_compose_envelope", labelText: "红包")
        moneyBtnView!.delegate = self
        bookBtnView = ScrollTabView(frame:CGRectOffset(rectOrigin, btnWidth*4, btnHeight) , imageName: "tabbar_compose_book", labelText: "书籍")
